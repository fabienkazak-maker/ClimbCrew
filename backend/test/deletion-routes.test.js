...
test("les suppressions administratives sont protégées et transactionnelles", async () => {
  const [server, routeManagement, accountDelete, integration, participantLifecycle] = await Promise.all([
  ...
  // La suppression de voie est extraite de server.js mais conserve
  ...
  // La suppression de compte est désormais extraite et conserve les mêmes
  // garde-fous, le verrou transactionnel et la protection du dernier admin.
