...
export const AVATAR_OPTIONS = Object.freeze([
  ...
  { id: "leopard_neiges", label: "Léopard des neiges", group: "Animaux", image: asset(AVATAR_ROOT, "leopard-neiges"), evolutionImages: evolutionImages("leopard_neiges") },
  { id: "orang_outan", label: "Orang-outan bloqueur", group: "Animaux", image: asset(AVATAR_ROOT, "orang-outan"), evolutionImages: evolutionImages("orang_outan") },
  ...
  { id: "chevalier", label: "Chevalier grimpeur", group: "Personnages", image: asset(AVATAR_ROOT, "chevalier"), evolutionImages: evolutionImages("chevalier") },
  ...
  { id: "fraise", label: "Fraise verticale", group: "Fruits", image: asset(PROFILE_ROOT, "avatar-fraise"), evolutionImages: evolutionImages("fraise") },
  { id: "banane", label: "Banane dynamique", group: "Fruits", image: asset(PROFILE_ROOT, "avatar-banane"), evolutionImages: evolutionImages("banane") },
