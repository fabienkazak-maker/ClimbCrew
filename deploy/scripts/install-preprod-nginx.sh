...
# Le TLS public est terminé par un frontal amont. Le runner de déploiement
# peut traverser une inspection TLS d'entreprise et recevoir le certificat
# du frontal local au lieu du certificat public du domaine. Le déploiement ne
# doit donc pas dépendre d'un contrôle TLS public effectué depuis ce runner.
# Le contrat Nginx est vérifié localement ci-dessous avant la bascule ; les
# contrôles publics post-déploiement restent responsables de la validation
# HTTPS depuis leur environnement dédié.
